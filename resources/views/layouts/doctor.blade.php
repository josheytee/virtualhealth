...
<nav class="deep-orange">
    <div class="nav-wrapper">
        ...
        <a class="brand-logo left" href="{{ url('/') }}">
            {{ config('app.name', 'VH Clinic') }}
        </a>

        <ul class="right hide-on-med-and-down">
            @if (auth('doctor')->guest())
                <li><a href="{{ route('doctors.login') }}">Login</a></li>
                <li><a href="{{ route('doctors.register') }}">Register</a></li>
            @else
                <li><a href="{{ route('doctors.home') }}">Home</a></li>
                <li>
                    <a href="{{ route('doctor',['username'=> auth('doctor')->user()->username]) }}">
                        <div class="chip deep-orange">
                            <img src="{{asset('images/i.png')}}">
                            {{auth('doctor')->user()->firstname}}
                        </div>
                    </a>
                </li>
    ...
    <div class="row">
        ...
        <div class="col m12 l3 s12">
            ...
            <div class="footer-download-wrapper">
                ...
                <div class="footer-download-badges">
                    ...
                    <div class="footer-download-item">
                        <a href="http://bit.ly/CuraWeb2" target="_blank">
                            <svg version="1" id="artwork" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 135 40">
                                <style>.st0 {
                                        fill: #fff;
                                        fill-opacity: 0
                                    }
